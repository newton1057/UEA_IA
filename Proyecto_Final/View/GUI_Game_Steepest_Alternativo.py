...
class Steepest:
    ...
    def Algoritmo_Steepest(self, Evaluacion_Estado):
        print("Aplicando algoritmo Steepest")
        #self.Game_Board.Print_GameBoard()
        ...
        if self.Validar_Solucion():
            ...
            if len(Reglas) > 0:
                ...
                print("Posicion mayor evaluacion: ", Posicion)
                for i in range(1, 6):
                ...
                if Regla_Aplicada is not None and Evaluacion is not None:
                    ...
                    if (self.Evaluar_Estado(Evaluacion_Estado, Evaluacion_Aux)):
                        ...
                        print("Evaluacion del estado original: ", Evaluacion_Estado)
                        
                        
                        
                        #print("Regla aplicada: ", Movimiento)
                        #print("Evaluacion del estado: ", Evaluacion_Estado)
